...
import GlobalLayout from "/Users/nly/all/fe/notes/node_modules/@vuepress/core/lib/client/components/GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-35dd97a0").then(next)
    },
  },
  {
    path: "/index.html",
  ...
  },
  {
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-684c492b").then(next)
    },
  },
  {
    path: "/软件资源/软件资源.html",
